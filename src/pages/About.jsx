      ...
      <section className='about py-16'>
        <div className='container'>
          ...
          <div className='grid grid-cols-4 gap-5 mt-5 md:grid-cols-2'>
            <AboutCard color='bg-[#2D69F0] border-4 border-black' icon={<MdCastForEducation size={50} />} title='4,000 Online courses' desc="You don't have to struggle alone, you've " />
            <AboutCard color='bg-[#DD246E] border-4 border-black' icon={<MdCastForEducation size={50} />} title='4,000 Online courses' desc="You don't have to struggle alone, you've " />
            <AboutCard color='bg-[#8007E6] border-4 border-black' icon={<MdCastForEducation size={50} />} title='4,000 Online courses' desc="You don't have to struggle alone, you've " />
            <AboutCard color='bg-[#0CAE74] border-4 border-black' icon={<MdCastForEducation size={50} />} title='4,000 Online courses' desc="You don't have to struggle alone, you've " />
          </div>
        </div>
      </section>
      <AboutContent />
          ...
          <div className='heading w-4/5 md:w-full'>
            ...
            <ul className='my-5'>
              <li className='text-sm flex items-center gap-5'>
                <AiOutlineCheck className='text-green-800 ' /> Upskill your organization.
              </li>
