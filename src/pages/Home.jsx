...
export const HomeContent = () => {
  return (
    <>
      <section className='bg-lime-200 py-10 h-[92vh] md:h-full'>
          ...
          <div className='flex items-center justify-center md:flex-col'>
            <div className='left w-1/2 text-black md:w-full'>
              ...
              <div className='relative text-gray-600 focus-within:text-gray-400 mt-5'>
                <input type='search' className='py-3 text-sm  bg-white rounded-md pl-10 focus:outline-none border-4 border-black' placeholder='Search...' autocomplete='off' />
            ...
            <div className='right w-1/2 md:w-full relative '>
                ...
                <div className='img h-[85vh] w-full'>
                  <img src={heroImg} alt='' className='h-full w-full rounded object-contain z-20 relative' />
                </div>
